...
import org.shaded.apache.http.auth.AuthSchemeProvider;
import org.shaded.apache.http.client.AuthenticationStrategy;
import org.shaded.apache.http.client.BackoffManager;
import org.shaded.apache.http.client.ConnectionBackoffStrategy;
...
import org.shaded.apache.http.client.RedirectStrategy;
...
import org.shaded.apache.http.client.config.AuthSchemes;
import org.shaded.apache.http.client.config.RequestConfig;
import org.shaded.apache.http.client.entity.InputStreamFactory;
import org.shaded.apache.http.client.protocol.RequestAcceptEncoding;
import org.shaded.apache.http.client.protocol.RequestAddCookies;
import org.shaded.apache.http.client.protocol.RequestAuthCache;
...
import org.shaded.apache.http.client.protocol.RequestExpectContinue;
import org.shaded.apache.http.client.protocol.ResponseContentEncoding;
...
import org.shaded.apache.http.conn.DnsResolver;
import org.shaded.apache.http.conn.HttpClientConnectionManager;
import org.shaded.apache.http.conn.SchemePortResolver;
...
import org.shaded.apache.http.conn.socket.LayeredConnectionSocketFactory;
...
import org.shaded.apache.http.conn.ssl.X509HostnameVerifier;
import org.shaded.apache.http.conn.util.PublicSuffixMatcher;
import org.shaded.apache.http.conn.util.PublicSuffixMatcherLoader;
import org.shaded.apache.http.cookie.CookieSpecProvider;
...
import org.shaded.apache.http.impl.auth.KerberosSchemeFactory;
import org.shaded.apache.http.impl.auth.NTLMSchemeFactory;
import org.shaded.apache.http.impl.auth.SPNegoSchemeFactory;
import org.shaded.apache.http.impl.conn.DefaultProxyRoutePlanner;
import org.shaded.apache.http.impl.conn.DefaultRoutePlanner;
import org.shaded.apache.http.impl.conn.DefaultSchemePortResolver;
import org.shaded.apache.http.impl.conn.PoolingHttpClientConnectionManager;
import org.shaded.apache.http.impl.conn.SystemDefaultRoutePlanner;
import org.shaded.apache.http.impl.execchain.BackoffStrategyExec;
import org.shaded.apache.http.impl.execchain.ClientExecChain;
import org.shaded.apache.http.impl.execchain.MainClientExec;
import org.shaded.apache.http.impl.execchain.ProtocolExec;
import org.shaded.apache.http.impl.execchain.RedirectExec;
import org.shaded.apache.http.impl.execchain.RetryExec;
import org.shaded.apache.http.impl.execchain.ServiceUnavailableRetryExec;
...
`     */
    ...
    /**
     * Assigns default {@link org.shaded.apache.http.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link org.shaded.apache.http.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     *
    ...
    /**
     * Assigns a map of {@link InputStreamFactory}s
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "org.shaded.apache.http.client", getClass());
            }
        }

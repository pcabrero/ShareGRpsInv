...
/**
 * Default implementation of {@link org.shaded.apache.http.client.HttpClient} pre-configured
 ...
 *  <li>{@link org.shaded.apache.http.conn.params.ConnRoutePNames#FORCED_ROUTE}</li>
 *  <li>{@link org.shaded.apache.http.conn.params.ConnRoutePNames#LOCAL_ADDRESS}</li>
 *  <li>{@link org.shaded.apache.http.conn.params.ConnRoutePNames#DEFAULT_PROXY}</li>
 *  <li>{@link org.shaded.apache.http.cookie.params.CookieSpecPNames#DATE_PATTERNS}</li>
 *  <li>{@link org.shaded.apache.http.cookie.params.CookieSpecPNames#SINGLE_COOKIE_HEADER}</li>
 *  <li>{@link org.shaded.apache.http.auth.params.AuthPNames#CREDENTIAL_CHARSET}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#COOKIE_POLICY}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#HANDLE_AUTHENTICATION}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#HANDLE_REDIRECTS}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#MAX_REDIRECTS}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#ALLOW_CIRCULAR_REDIRECTS}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#VIRTUAL_HOST}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#DEFAULT_HOST}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#DEFAULT_HEADERS}</li>
 *  <li>{@link org.shaded.apache.http.client.params.ClientPNames#CONN_MANAGER_TIMEOUT}</li>
 * </ul>
 *
 * @since 4.0
 *
...
public class DefaultHttpClient extends AbstractHttpClient {
    ...
    public static void setDefaultHttpParams(final HttpParams params) {
        ...
        HttpProtocolParams.setUserAgent(params, VersionInfo.getUserAgent("Apache-HttpClient",
                "org.shaded.apache.http.client", DefaultHttpClient.class));
    }
